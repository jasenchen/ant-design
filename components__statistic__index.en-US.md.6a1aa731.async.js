"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[8706],{14510:function(s,e,l){l.r(e);var r=l(2143),Z=l(50250),m=l(59378),v=l(5648),c=l(74775),u=l(5937),h=l(2068),p=l(74399),C=l(63942),E=l(71964),g=l(29188),x=l(15506),P=l(56140),_=l(5388),D=l(49545),O=l(6965),f=l(13140),M=l(95127),w=l(74418),A=l(73024),a=l(28257),d=l(67294),t=l(50985);function i(){var o=(0,a.eL)(),n=o.texts;return(0,t.tZ)(a.dY,null,(0,t.tZ)(d.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"when-to-use"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,t.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,t.tZ)("ul",null,(0,t.tZ)("li",null,n[1].value),(0,t.tZ)("li",null,n[2].value)),(0,t.tZ)("h2",{id:"examples"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,t.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,t.tZ)(_.Z,{items:[{demo:{id:"components-statistic-demo-basic"},previewerProps:{title:"Basic",filename:"components/statistic/demo/basic.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Simplest Usage.</p>"}},{demo:{id:"components-statistic-demo-unit"},previewerProps:{title:"Unit",filename:"components/statistic/demo/unit.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Add unit through <code>prefix</code> and <code>suffix</code>.</p>"}},{demo:{id:"components-statistic-demo-card"},previewerProps:{title:"In Card",filename:"components/statistic/demo/card.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Display statistic data in Card.</p>",style:`.site-statistic-demo-card {
  padding: 30px;
  background: #ececec;
}`}},{demo:{id:"components-statistic-demo-countdown"},previewerProps:{title:"Countdown",filename:"components/statistic/demo/countdown.tsx",jsx:`import React from 'react';
import { Col, Row, Statistic } from 'antd';

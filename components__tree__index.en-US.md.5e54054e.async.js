"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[1185],{52243:function(c,a,t){t.r(a);var p=t(2143),h=t(50250),Z=t(59378),v=t(5648),d=t(74775),l=t(5937),_=t(2068),m=t(74399),f=t(63942),y=t(71964),x=t(29188),k=t(15506),g=t(56140),u=t(5388),D=t(49545),w=t(6965),E=t(13140),O=t(95127),K=t(74418),b=t(73024),o=t(28257),i=t(67294),n=t(50985);function r(){var s=(0,o.eL)(),e=s.texts;return(0,n.tZ)(o.dY,null,(0,n.tZ)(i.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("p",null,e[1].value,(0,n.tZ)("code",null,e[2].value),e[3].value,(0,n.tZ)("code",null,e[4].value),e[5].value),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(u.Z,{items:[{demo:{id:"components-tree-demo-basic"},previewerProps:{title:"Basic",filename:"components/tree/demo/basic.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>The most basic usage, tell you how to use checkable, selectable, disabled, defaultExpandKeys, and etc.</p>"}},{demo:{id:"components-tree-demo-basic-controlled"},previewerProps:{title:"Controlled Tree",filename:"components/tree/demo/basic-controlled.tsx",jsx:`import React, { useState } from 'react';
import { Tree } from 'antd';
const treeData = [
  {
    title: '0-0',
...
export default App;
`,description:"<p>Controlled mode lets parent nodes reflect the status of child nodes more intelligently.</p>"}},{demo:{id:"components-tree-demo-draggable"},previewerProps:{title:"draggable",filename:"components/tree/demo/draggable.tsx",jsx:`import React, { useState } from 'react';
import { Tree } from 'antd';
const x = 3;
const y = 2;
const z = 1;
...
export default App;
`,description:"<p>Drag treeNode to insert after the other treeNode or insert into the other parent TreeNode.</p>"}},{demo:{id:"components-tree-demo-dynamic"},previewerProps:{title:"load data asynchronously",filename:"components/tree/demo/dynamic.tsx",jsx:`import React, { useState } from 'react';
import { Tree } from 'antd';
const initTreeData = [
  {
...
export default App;
`,description:"<p>To load data asynchronously when click to expand a treeNode.</p>"}},{demo:{id:"components-tree-demo-search"},previewerProps:{title:"Searchable",filename:"components/tree/demo/search.tsx",jsx:`import React, { useMemo, useState } from 'react';
...
`,description:"<p>Searchable Tree.</p>",style:`.site-tree-search-value {
  color: #f50;
}`}},{demo:{id:"components-tree-demo-line"},previewerProps:{title:"Tree with line",filename:"components/tree/demo/line.tsx",jsx:`import React, { useState } from 'react';
...
export default App;
`,description:"<p>Tree with connected line between nodes, turn on by <code>showLine</code>, customize the preseted icon by <code>switcherIcon</code>.</p>"}},{demo:{id:"components-tree-demo-customized-icon"},previewerProps:{title:"Customize Icon",filename:"components/tree/demo/customized-icon.tsx",jsx:`import React from 'react';
import {
  DownOutlined,
  FrownFilled,
  FrownOutlined,
...
export default App;
`,description:"<p>You can customize icons for different nodes.</p>"}},{demo:{id:"components-tree-demo-directory"},previewerProps:{title:"directory",filename:"components/tree/demo/directory.tsx",jsx:`import React from 'react';
import { Tree } from 'antd';
...
export default App;
`,description:"<p>Built-in directory tree. <code>multiple</code> support <code>ctrl(Windows)</code> / <code>command(Mac)</code> selection.</p>"}},{demo:{id:"components-tree-demo-switcher-icon"},previewerProps:{title:"Customize collapse/expand icon",filename:"components/tree/demo/switcher-icon.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>customize collapse/expand icon of tree node</p>"}},{demo:{id:"components-tree-demo-virtual-scroll"},previewerProps:{title:"Virtual scroll",filename:"components/tree/demo/virtual-scroll.tsx",jsx:`import React from 'react';
import { Tree } from 'antd';
...
export default App;
`,description:"<p>Use virtual list through <code>height</code> prop.</p>"}},{demo:{id:"components-tree-demo-drag-debug"},previewerProps:{debug:!0,title:"Drag Debug",filename:"components/tree/demo/drag-debug.tsx",jsx:`// @ts-nocheck
...
export default App;
`}},{demo:{id:"components-tree-demo-big-data"},previewerProps:{debug:!0,title:"Big data",filename:"components/tree/demo/big-data.tsx",jsx:`import React from 'react';
import { Tree } from 'antd';
const treeData = [];
...
export default App;
`,description:"<p>Plenty of tree nodes.</p>"}},{demo:{id:"components-tree-demo-block-node"},previewerProps:{title:"Block Node",filename:"components/tree/demo/block-node.tsx",jsx:`import React from 'react';
import { Tree } from 'antd';
const treeData = [
  {
    title: 'parent',

...
export default App;
`,description:'<p>By using <code>components</code>, we can integrate table with <a href="https://github.com/react-dnd/react-dnd">react-dnd</a> to implement drag sorting function.</p>',style:`#components-table-demo-drag-sorting .ant-table tr.drop-over-downward td {

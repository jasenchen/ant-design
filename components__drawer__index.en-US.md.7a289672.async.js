...
<p>Note: <code>style</code> and <code>className</code> props are moved to Drawer panel in v5 which is aligned with Modal component. Original <code>style</code> and <code>className</code> props are replaced by <code>rootStyle</code> and <code>rootClassName</code>.</p>`,style:`.site-drawer-render-in-current-wrapper {
  position: relative;
  height: 200px;
  padding: 48px;
  overflow: hidden;
